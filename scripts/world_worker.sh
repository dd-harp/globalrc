...
/ihme/singularity-images/rstudio/shells/execRscript.sh -i /ihme/singularity-images/rstudio/ihme_rstudio_4030.img -s  rc_run_worker.R --config=world_mean.toml  --outvars=201124_global_median --years=2019:2019 --draws=100 --tasks=433
